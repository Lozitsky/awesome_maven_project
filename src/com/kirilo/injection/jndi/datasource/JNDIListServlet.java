...
public class JNDIListServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        writer.append("<h3><a href=\"http://localhost:8080/awesome_maven_project/\"> Hello Servlet </a></h3>\n");
...
//                if ("MySQLDataSource".equals(name) && object instanceof DataSource) {
                if (object instanceof DataSource) {
                    ...
                    try (Connection connection = ds.getConnection()) {
                        ...
                        jndiList.add("<h3><a href=\"http://localhost:8080/awesome_maven_project/JNDIServlet\"> JNDIServlet </a></h3>");
                        jndiList.add("<h3><a href=\"http://localhost:8088/?server=db&username=admin_db&db=awesome_maven_project\"> Adminer </a></h3>");
